...
"""
s.add(hash.md5(0, filesize] == "b7dc94ca98aa58dabb5404541c812db2")
"""
...
#s.add(hash.sha256(14, 2] == "403d5f23d149670348b147a15eeb7010914701a7e99aad2e43f90cfa0325c76f")
s.add(flag[14] == ord(" "))
s.add(flag[15] == ord("s"))

#s.add(hash.sha256(56, 2] == "593f2d04aab251f60c9e4b8bbc1e05a34e920980ec08351a18459b2bc7dbf2f6")
s.add(flag[56] == ord("f"))
s.add(flag[57] == ord("l"))


#s.add(hash.md5(0, 2] == "89484b14b36a8d5329426a3d944d2983")
s.add(flag[0] == ord("r"))
s.add(flag[1] == ord("u"))

#s.add(hash.md5(76, 2] == "f98ed07a4d5f50f7de1410d905f1477f")
s.add(flag[76] == ord("i"))
s.add(flag[77] == ord("o"))

#s.add(hash.md5(50, 2] == "657dae0913ee12be6fb2a6f687aae1c7")
s.add(flag[50] == ord("3"))
s.add(flag[51] == ord("A"))

#s.add(hash.md5(32, 2] == "738a656e8e8ec272ca17cd51e12f558b")
s.add(flag[32] == ord("u"))
s.add(flag[33] == ord("l"))


#s.add(hash.crc32(8, 2] == 0x61089c5c)
s.add(flag[8] == ord("r"))
s.add(flag[9] == ord("e"))
#s.add(hash.crc32(34, 2] == 0x5888fc1b)
s.add(flag[34] == ord("e"))
s.add(flag[35] == ord("A"))
#s.add(hash.crc32(63, 2] == 0x66715919)
s.add(flag[63] == ord("n"))
s.add(flag[64] == ord("."))
#s.add(hash.crc32(78, 2] == 0x7cab8d64)
s.add(flag[78] == ord("n"))
s.add(flag[79] == ord(":"))
